...
int main (void) {
    // Dados
    int distancia, velocidade_media, tempo_gasto, horario_saida, horario_chegada;
    ...
    printf("Você chegou em São josé dos campos(SP) ás %dh, foi cerca de %d horas de viagem \n", horario_chegada, tempo_gasto);
